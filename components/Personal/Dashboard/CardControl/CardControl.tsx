...
import { blockDebitCardForm, blockDebitCardSchema } from "@/lib/schemas/cardschema";
...
const CardControl = () => {
 ...
 const methods = useForm<blockDebitCardForm>({
  resolver: zodResolver(blockDebitCardSchema),
  mode: "onChange",            
  ...
  const renderStepContent = () => {
    switch (step) {
      ...
      case 3:
        return (
          <>
            <SuccessModal title={"Card Blocked Successfully"} />
            <div className="py-4">
              <Button
                type="button"
                onClick={resetForm}
